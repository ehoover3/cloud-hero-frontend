function HandsOnTutorials() {
  return (
    <div>
      ...
      <div>Run a Serverless "Hello, World!" with AWS Lambda</div>
      <div>https://aws.amazon.com/getting-started/hands-on/run-serverless-code/?ref=gsrchandson&id=updated</div>
...
export default HandsOnTutorials;
