...
Build a solution that:
 ...
 What do you recommend as the most efficient solution?`,
    ...
    answerOptions: [
      "DynamoDB table with a primary key with the category as the partition key and the version number as the sort key. Create a global secondary index with the name as the partition key",
      ...
      "Permanently store the name, version number, and category info about the games in an Elasticache for Memcached instance",
